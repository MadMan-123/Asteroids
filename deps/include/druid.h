...
#define AUDIO_MAX_VOICES 32
    ...
    typedef enum
    {
        ...
        BUTTON_SQUARE = SDL_GAMEPAD_BUTTON_WEST,
        BUTTON_CIRCLE = SDL_GAMEPAD_BUTTON_EAST,
        BUTTON_TRIANGLE = SDL_GAMEPAD_BUTTON_NORTH,
        BUTTON_CROSS = SDL_GAMEPAD_BUTTON_SOUTH,
